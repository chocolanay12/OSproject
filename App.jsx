...
export default function App() {
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      link: "https://projectday.vercel.app/?fbclid=IwY2xjawOaS5BleHRuA2FlbQIxMABicmlkETFPWWx0QUxSTFgxeDBQRkdRc3J0YwZhcHBfaWQQMjIyMDM5MTc4ODIwMDg5MgABHqcr1H2HyoBw_qaIhryC62yPa0GX9-xQ9WHetoSIkfotr2-fsAJrtL8murTc_aem_Qe_vXep5TWX1QLQx_8KovA",
        ...
        <header className="flex flex-col md:flex-row items-center gap-8 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-colors duration-300">
          ...
          <div className="flex-1">
            <h2 className="text-3xl font-bold mb-2">
              Bern Justin Tajanlangit <span className="text-blue-500"></span>
            </h2>
            ...
            <p className="text-lg font-medium mb-4">BSIT Student</p>
          ...
          <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition duration-300">
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <span>
                  <strong> 2023 — Present</strong><br />Cordova Public College
                </span>
              </li>
              ...
              <li className="flex items-center gap-2">
                <FaCircle className="text-green-500 text-xs mr-5" />
                <span>
                  <strong>2022 - 2023 — Senior High</strong><br />Cordova National High School
                </span>
              </li>
              ...
              <li className="flex items-center gap-2">
                <FaCircle className="text-green-500 text-xs mr-5" />
                <span>
                  <strong>2017 - 2018 — Junior High</strong><br />Cordova National High School
                </span>
              </li>
              ...
              <li className="flex items-center gap-2">
                <FaCircle className="text-green-500 text-xs mr-5" />
                <span>
                  <strong>2010 - 2017 — Elementary</strong><br />Cordova Central Elementary School
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <section className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition duration-300">
            ...
            <div className="grid sm:grid-cols-1 gap-4">
              <a href="https://myaccount.google.com/u/1/?gar=WzEyMF0&hl=en&utm_source=OGB&utm_medium=act" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-300">
                <FaEnvelope className="text-blue-600" /> Email
              </a>
              <a href="tel:+63 9542270337" className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-300">
                <FaPhone className="text-green-600" /> Phone
              </a>
              <a href="https://www.facebook.com/beejing08" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-300">
                <FaFacebook className="text-blue-700" /> Facebook
              </a>
              <a href="https://www.instagram.com/brnjstn_8/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-300">
